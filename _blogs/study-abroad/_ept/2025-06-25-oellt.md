...
permalink: /study-abroad/ept/oellt/Oxford-ellt-comprehensive-guide/
toc: true
category: oellt
tag: [oellt, english, abroad-studies, ept]
keywords: "learn English, English learning, oellt"
---
...
For example, if your test starts at 14:00, the Stage 2 question and test instructions will appear on your dashboard like **[this](https://oxfordellt.com/wp-content/uploads/2024/03/OxfordELLT_Speaking_Sample_1_March24.pdf){:target="_blank" rel="noopener noreferrer"}**. You will then have 15 minutes to prepare, during which video and audio recording will not be active. Once the 15-minute countdown ends, a pop-up saying “Open Zoom Link” will appear on your dashboard. It is very important that you join the Zoom meeting promptly at that time.
...
- ❓**Topic:** Consider the challenge listed below and prepare a short presentation on the topic: “People around the world enjoy watching sports for many different reasons.” (Source: psychologytoday.com)
  - What are the good things and bad things about watching sport? Are there any sports that are more entertaining to watch than others? Consider both sides and give a personal opinion based on your own experience. Your presentation must:
    - Include an argument in favour and an argument against.
    - Include a personal reflection.
...
📖 Some additional Oxford ELLT Speaking Questions **[Oxford ELLT Speaking Questions](https://oxfordellt.com/wp-content/uploads/2023/05/OXFORD-ELLT-Speaking-Stage-4.docx.pdf){:target="_blank" rel="noopener noreferrer"}** for Practice.

---

**Presentations**

- ❓**Topic:**  A study shows that children in sports teams who see bad behaviour from their parents during matches are more likely to behave badly themselves.
  If parents watch their children's sports matches, should they stay silent?

  You must:  Present one argument in favour and one against.  Include a personal reflection. Speak for 3–5 minutes.

- ❓**Topic:** Italy is suggesting asking people who review restaurants online to show identification and prove they visited the place.
  -  What are some advantages and disadvantages of showing personal documents for online reviews? Discuss both sides and include your own opinion.

  You must:  Present one argument in favour and one against.  Include a personal reflection. Speak for 3–5 minutes.

**Additional Sample Test Questions**

- <a href="{{ site.baseurl }}/assets/files/OxfordELLT_Speaking_Sample_1.pdf" target="_blank">OELLT sample test 1</a>, - <a href="{{ site.baseurl }}/assets/files/OxfordELLT_Speaking_Sample_2.pdf" target="_blank">OELLT sample test 2</a>, - <a href="{{ site.baseurl }}/assets/files/OxfordELLT_Speaking_Sample_3.pdf" target="_blank">OELLT sample test 3</a>, - <a href="{{ site.baseurl }}/assets/files/OxfordELLT_Speaking_Sample_4.pdf" target="_blank">OELLT sample test 4</a>, - <a href="{{ site.baseurl }}/assets/files/OxfordELLT_Speaking_Sample_5.pdf" target="_blank">OELLT sample test 5</a>, - <a href="{{ site.baseurl }}/assets/files/OxfordELLT_Speaking_Sample_6.pdf" target="_blank">OELLT sample test 6</a>, - <a href="{{ site.baseurl }}/assets/files/OxfordELLT_Speaking_Sample_7.pdf" target="_blank">OELLT sample test 7</a>
